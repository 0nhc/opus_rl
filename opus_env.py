...
class OpusEnv:
    def __init__(self, num_envs, env_cfg, obs_cfg, reward_cfg, command_cfg, domain_rand_cfg, show_viewer=False, device="cuda"):
        ...
        self.simulate_action_latency = False  # there is a 1 step latency on Unitree real robot, but I'm doing Sim2Sim
        self.dt = 0.002 # Control Frequency is 50Hz on Unitree Go2 Real Robot
        ...
        self.left_foot_link = self.robot.get_link(name='left_foot_link')
        self.right_foot_link = self.robot.get_link(name='right_foot_link')
        self.left_calf_link = self.robot.get_link(name='left_calf_link')
        self.right_calf_link = self.robot.get_link(name='right_calf_link')
        self.left_foot_id_local = self.left_foot_link.idx_local
        self.right_foot_id_local = self.right_foot_link.idx_local
        self.left_calf_id_local = self.left_calf_link.idx_local
        self.right_calf_id_local = self.right_calf_link.idx_local
        self.feet_indices = [self.left_foot_id_local,
                             self.right_foot_id_local]
        self.calf_indices = [self.left_calf_id_local,
                             self.right_calf_id_local]
        self.feet_num = len(self.feet_indices)
        self.calf_num = len(self.calf_indices)
        ...
        self.calf_ori = self.robot.get_links_quat()[:, self.calf_indices, :]
        # Gait Phase
        self.period = 0.6
        self.offset = 0.375
        ...
        self.pelvis_link = self.robot.get_link(name='pelvis_link')
